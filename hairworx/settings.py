"""
Django settings for hairworx project.
...
WSGI_APPLICATION = 'hairworx.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_HOST_USER='hairworxnoreply@gmail.com'
EMAIL_HOST_PASSWORD='cmpkwsmwhwwfloex'
EMAIL_USE_TLS=True
